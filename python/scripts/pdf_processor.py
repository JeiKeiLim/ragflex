...
class PDFProcessor:
    def __init__(self, pdf: str) -> None:
        ...
        """
        self._pdf_text = self._extract_text_from_pdf(pdf)
    ...
    def pdf_file_path(self) -> str:
        """
        Returns the file path to the PDF from which the text was extracted.
        """
        return self._pdf_file_path

    def _extract_text_from_pdf(self, pdf: Union[str, bytes]) -> str:
        """
